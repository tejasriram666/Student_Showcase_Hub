// This gpa calculator script was written by
   ...
   /////////////////////////////////////////////////////////////
   // COMPLETION RATE CALC FUNCTION
   /////////////////////////////////////////////////////////////

   function compRateCalc() // copied form goalCalc()
   {

     // set variables
     var LocalCumCr_Attemptednum = 0;
     var LocalCumCr_Earnednum = 0;
     var CurrentCrnum = 0;

     // retrieve user input
     LocalCumCr_Attemptednum = parseFloat(document.CompRateForm.LocalCumCr_Attempted.value);
     LocalCumCr_Earnednum = parseFloat(document.CompRateForm.LocalCumCr_Earned.value);
     CurrentCrnum = parseFloat(document.CompRateForm.CurrentCr.value);

     // this if-check prevents a divide by zero error
     if (document.CompRateForm.LocalCumCr_Attempted.value == "") {
       alert("Error - You did not enter any credit values!");
       return 0;
     }

     if (document.CompRateForm.CurrentCr.value == "") {
       CurrentCrnum = 0
     }

     // find completion rate
     var compRate = 0;
     compRate = round2d((LocalCumCr_Earnednum / (LocalCumCr_Attemptednum - CurrentCrnum)) * 100);

     alert("Your current completion rate is " + eval(compRate) + "%");

     return 0;
   }

   // SEMESTER CREDITS CALC FUNCTION
   var table = '';
   ...
   function getTotalSemesterCredits() {
     ...
     if (document.getElementById('credits7').value != '') {
       totalSemesterCredits += parseFloat(document.getElementById('credits7').value);
     }
     if (document.getElementById('credits8').value != '') {
       totalSemesterCredits += parseFloat(document.getElementById('credits8').value);
     }
   ...
   function grades() {
     ...
     if (isError == false && parseFloat(document.getElementById('current_credits').value) != totalCurrentCredits) {
       if (document.getElementById('current_credits').value != '') {
         alert('The number of current credits you\'ve entered in your semester forecast (No. of Credits in Step 2) does not match what you\'ve entered for your current information (Registered/Current Credits in Step 2). Please check that they are equal.');
         isError = true;
       } else {
     ...
     if (isError == false) {
       ...
       gradeIndexesArray[6] = "grade7";
       gradeIndexesArray[7] = "grade8";
       ...
       for (var z = 0; z <= creditsArray.length - 1; z++) {
         ...
         if (document.getElementById(creditsArray[z]).value != '') {
           ...
           //if the grade selected for course z is an "S", then credits are added only to attempted.
           if (gradeZIndex == 14) {
             semesterAttemptedCredits += creditsZValue;
             semesterEarnedCredits += creditsZValue;
           } //end if

           //if the grade selected for course z is an W, or I, then credits are added to attempted and gpacredits.  no credits and gpa points earned.
           else if (gradeZIndex == 15 | gradeZIndex == 19) {
             semesterAttemptedCredits += creditsZValue;
           } //end else if

           //if the grade selected for course z is an F, or NC (FW, FN, U), then credits are added to attempted and gpacredits.  no credits and gpa points earned.
           else if (gradeZIndex == 13 | gradeZIndex == 16 | gradeZIndex == 17 | gradeZIndex == 18) {
             semesterAttemptedCredits += creditsZValue;
       ...
       repeatArray[6] = "repeat7";
       repeatArray[7] = "repeat8";
       ...
       previousGradeArray[6] = "previous_grade7";
       previousGradeArray[7] = "previous_grade8";

       //other variables used for repeat course calculation purposes.
       var totalRepeatGpaCredits = 0;
       var totalRepeatGpaCreditsCompRate = 0;
       ...
       for (var q = 0; q <= repeatArray.length - 1; q++) {
         if (document.getElementById(repeatArray[q]).checked == true) {
           ...
           //if the previous grade selected for repeat course is an A+ - D-
           if (previousGradeQIndex <= 12) {
             ...
             totalRepeatGpaCreditsCompRate += creditsQValue;
             //document.getElementById('forecast_cum_gpa').value = totalRepeatGpaPoints;
           } //end if
           //else if (previousGradeQIndex >= 13) {
           //  totalRepeatGpaPoints += 0;
           //  totalRepeatGpaCredits += creditsQValue;

           //}//end else if

           //if the previous grade selected for repeat course is an S, W, U, or I
           else if (previousGradeQIndex == 14 | previousGradeQIndex == 15 | previousGradeQIndex == 18 | previousGradeQIndex == 19) {
             totalRepeatGpaPoints += 0;
             totalRepeatGpaCredits += 0;
             totalRepeatGpaCreditsCompRate += 0;

           } //end else if

           //if the previous grade selected for repeat course is an F, FW, or FN
           else if (previousGradeQIndex >= 13 | previousGradeQIndex >= 16 | previousGradeQIndex >= 17) {
             totalRepeatGpaPoints += 0;
             totalRepeatGpaCredits += creditsQValue;
             totalRepeatGpaCreditsCompRate += 0;
       ...
       var adjustedLocalEarnedCredits = parseFloat(localEarnedCredits) - totalRepeatGpaCreditsCompRate;
   ...
   function clearForm() {
     ...
     document.getElementById('repeat7').checked = false;
     document.getElementById('repeat8').checked = false;
     enable1();
     enable2();
     enable3();
     enable4();
   ...
   function determineStatuses2(semester_gpa, semester_comprate, new_cum_gpa, new_cum_comprate) {
     ...
     if (document.getElementById('message_display').value != '') {
       if (parseFloat(semester_gpa) <= 2.5 & parseFloat(semester_comprate) <= 75.00) {
         document.getElementById('message_display2').value = "Based on your current information, you may already be on academic probation. Now, based on BOTH your semester GPA of " + semester_gpa + " and semester completion rate of " + semester_comprate + "%, you may be put on academic suspension. Please, contact your advisor immediately!";
       } else if (parseFloat(semester_gpa) <= 2.5) {
         document.getElementById('message_display2').value = "Based on your current information, you may already be on academic probation.  Now, based on your semester GPA of " + semester_gpa + ", you may be put on academic suspension.  Please, contact your advisor immediately!";
       } else if (parseFloat(semester_comprate) <= 75.00) {
         document.getElementById('message_display2').value = "Based on your current information, you may already be on academic probation.  Now, based on your semester completion rate of " + semester_comprate + ", you may be put on academic suspension.  Please, contact your advisor immediately!";
       }
     } //end if
     else {

       if (new_cum_gpa <= 2.0 & new_cum_comprate <= 66.66) {
         document.getElementById('message_display2').value = "Based on BOTH your forecast cumulative GPA of " + new_cum_gpa + " and forecast cumulative completion rate of " + new_cum_comprate + ", you may be put on academic probation.  Please, contact your advisor immediately!";
       ...
       } else if (new_cum_comprate <= 66.66) {
   ...
   var flag1 = false; //becomes true if completion fate falls below 66.66%
   ...
   function determineStatuses() {
     ...
     if (flag1 == true & flag2 == true) {
       document.getElementById('message_display').value = "Based on BOTH your cumulative completion rate of " + document.getElementById('local_cum_comprate').value + " AND your cumulative G.P.A of " + document.getElementById('local_cum_gpa').value + ", you may be on academic probation.  It is IMPORTANT that you see your advisor for academic guidance IMMEDIATELY.";
     } else if (flag1 == true & flag2 == false) {
       document.getElementById('message_display').value = "Based on your cumulative completion rate of " + document.getElementById('local_cum_comprate').value + ", you may be on academic probation.  It is IMPORTANT that you see your advisor for academic guidance IMMEDIATELY.";
     } else if (flag1 == false & flag2 == true) {
       document.getElementById('message_display').value = "Based on your cumulative G.P.A of " + document.getElementById('local_cum_gpa').value + ", you may be on academic probation.  It is IMPORTANT that you see your advisor for academic guidance IMMEDIATELY.";
     } else {
       document.getElementById('message_display').value = '';
     }
     flag1 = false;
   ...
   function calculatecompletionrate() {
     ...
     //    alert('Number of Current Credits cannot be negative.');
     //  }
     //  else {
     //    localCompletionRate = truncate(document.getElementById('local_cum_crearned').value / (document.getElementById('local_cum_crattempted').value - document.getElementById('current_credits').value) * 100);
     //    return localCompletionRate;
   ...
   function currentcumcomplrate() {
     ...
     if (clcrate == 100.00) {
       ...
       alert('Please check the number of credits you have entered for Local Cumulative Credits Attempted and/or Local Cumulative Credits Earned.');
     } else {
   ...
   function genable7() {
     if (document.getElementById('credits7').value != '') {
       ...
       document.getElementById('repeat7').disabled = false;
     } else {
       document.getElementById('grade7').selectedIndex = 0;
       document.getElementById('grade7').disabled = true;
       document.getElementById('repeat7').disabled = true;
       document.getElementById('repeat7').checked = false;
       document.getElementById('previous_grade7').selectedIndex = 0;
       document.getElementById('previous_grade7').disabled = true;
     }
   }
   ...
   function genable8() {
     if (document.getElementById('credits8').value != '') {
       ...
       document.getElementById('repeat8').disabled = false;
     } else {
       document.getElementById('grade8').selectedIndex = 0;
       document.getElementById('grade8').disabled = true;
       document.getElementById('repeat8').disabled = true;
       document.getElementById('repeat8').checked = false;
       document.getElementById('previous_grade8').selectedIndex = 0;
       document.getElementById('previous_grade8').disabled = true;
     }
   }
   ...
   //repeat 7
   function enable7() {
     if (document.getElementById('repeat7').checked == true) {
       document.getElementById('previous_grade7').disabled = false;
     } else {
       document.getElementById('previous_grade7').selectedIndex = 0;
       document.getElementById('previous_grade7').disabled = true;
     }
   ...
   //repeat 8
   function enable8() {
     if (document.getElementById('repeat8').checked == true) {
       document.getElementById('previous_grade8').disabled = false;
     } else {
       document.getElementById('previous_grade8').selectedIndex = 0;
       document.getElementById('previous_grade8').disabled = true;
     }
   ...
   see gnu.org/copyleft/lesser.html
   */
